				...
				<div class="col-xs-12">
					<div class="box">
						...
						<div class="box-body">
							<table
								@if (Auth::user()->admin)
									data-route="{{ route('admin-getorders-paid.getorderspaid') }}"
								@endif
								@if (Auth::user()->customer)
									data-route="{{ route('customer-getorders-paid.getorderspaid') }}"
								@endif
								id="orders-paid-table" class="table table-bordered table-hover" style="width: 1043px; ">
								<thead>
									<tr>
										<th>ID</th>
										<th>Name</th>
